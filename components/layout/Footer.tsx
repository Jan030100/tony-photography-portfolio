...
const socialLinks = [
  ...
  { href: "mailto:tony@tonyfarahlens.com", label: "Email" },
];
        ...
        <nav aria-label="Social links" className="flex items-center gap-8">
          {socialLinks.map((link) => (
            <a
              ...
              className="text-xs tracking-widest uppercase text-muted-foreground hover:text-accent transition-colors duration-300"
            >
              {link.label}
            </a>
          ))}
